...
STATE_TAX_RATE = 0.0                # State sales tax rate as decimal (e.g., 0.04225 for Missouri 4.225%)
LOCAL_TAX_RATE = 0.0                # Local/city sales tax rate as decimal (e.g., 0.02125 for Springfield 2.125%)
